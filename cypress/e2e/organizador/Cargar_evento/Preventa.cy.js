describe('Creacion de evento de inicio a fin con 1 fecha y 1 funcion', () => {
  it('debería loguearse con credenciales válidas', () => {
    ...
    cy.get('[data-type="hour"]').first().focus().type('{selectall}{backspace}').type(21);
    cy.get('[data-type="minute"]').first().focus().type('{selectall}{backspace}').type(30)
    })
